...
for kx=0:.01:0.5
    ...
    for s=1:2:length(val_show) 
        [val_1,err_1]=ddet0817_1(epi_plus,mu_minus,gamma_minus,epi_plus,mu_plus,gamma_plus,kz,kx,val_show(s));
        error_1(ccnt_1+s,:)=[val_1,err_1];
    end
    for s=2:2:length(val_show) 
        [val_2,err_2]=ddet0817_2(epi_plus,mu_minus,gamma_minus,epi_plus,mu_plus,gamma_plus,kz,kx,val_show(s));
        error_2(ccnt_2+s,:)=[val_2,err_2];
    end
    ccnt_1=ccnt_1+length(val_show);
    ccnt_2=ccnt_2+length(val_show);
    %% plot setting
